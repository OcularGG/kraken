// Gallery admin item status update API
...
module.exports = async (req, res) => {
    ...
    try {
        ...
        const itemIdIndex = urlParts.findIndex(part => part === 'admin') + 1;
        const itemId = urlParts[itemIdIndex];
        ...
        console.error('Gallery admin status API error:', error);
        return res.status(500).json({
            success: false,
